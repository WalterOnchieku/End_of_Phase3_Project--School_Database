...
teacher1 = Teacher(first_name="Bon", last_name="Jovi", subject=subject1, date_of_admission="2010-8-25")
teacher2 = Teacher(first_name="Dwayne", last_name="John", subject=subject2, date_of_admission="2012-1-10")
teacher3 = Teacher(first_name="Davie", last_name="Jones", subject=subject3, date_of_admission="2015-5-15")
...
student1 = Student(first_name="Alice", last_name="Brown", date_of_birth="2012-05-15", gender="F", student_class=class1, date_of_admission="2018-9-5")
student2 = Student(first_name="Bob", last_name="Green", date_of_birth="2011-09-23", gender="M", student_class=class1, date_of_admission="2018-9-5")
student3 = Student(first_name="Charlie", last_name="Black", date_of_birth="2013-03-11", gender="M", student_class=class2, date_of_admission="2019-9-4")
